...
const uint8_t KJG_BEDIO_UNPACK_LOOKUP[256][4] = { U3(0), U3((1<<6)),
        U3((2 << 6)), U3((3 << 6)) };
...
const uint8_t KJG_BEDIO_GENO2BED_LOOKUP[256] = { G3(0), G3((1 << 6)), G3(
        (2 << 6)), G3((3 << 6)) };
...
const uint8_t KJG_BEDIO_BED2GENO_LOOKUP[256] = { B3(0), B3((1 << 6)), B3(
        (2 << 6)), B3((3 << 6)) };
